...
- Refresh-rotation-specific regression coverage, broader expense pagination/schedule support and tracked CI rollout remain required before full expense delivery.
