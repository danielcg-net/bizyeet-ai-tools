...
- Authenticated command handlers, CLI argv wiring, MCP descriptors, installed cross-repository tests and end-to-end command coverage remain required before delivery.
