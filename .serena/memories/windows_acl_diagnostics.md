...
- Route the expected nonempty-file rejection through the same diagnostic executor too. Preserve the original rejection assertion and error; an unexpected startup timeout must remain distinguishable from the expected empty-file guard.
