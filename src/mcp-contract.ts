...
const pageSchema = Object.freeze({
  ...
  properties: Object.freeze({
    ...
    limit: Object.freeze({ maximum: 100, minimum: 1, type: "integer" }),
...
const exactSchema = Object.freeze({
  type: "object",
  properties: Object.freeze({ id: Object.freeze({ maxLength: 128, minLength: 1, type: "string" }) }),
...
export const mcpReadTools: readonly McpTool[] = Object.freeze([
  Object.freeze({
