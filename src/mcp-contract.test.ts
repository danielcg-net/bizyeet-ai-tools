...
void test("publishes only bounded, read-only MCP tools", () => {
  assert.deepEqual(mcpReadTools.map((tool) => tool.name), ["bizyeet_customers_list", "bizyeet_customers_get", "bizyeet_leads_list", "bizyeet_leads_get", "bizyeet_payments_list", "bizyeet_payments_get", "bizyeet_payments_list_with_relationships", "bizyeet_payments_get_with_relationships", "bizyeet_payments_received_summary", "bizyeet_reports_taxes", "bizyeet_expenses_list", "bizyeet_expenses_get", "bizyeet_bookings_upcoming", "bizyeet_services_list", "bizyeet_services_get"]);
  ...
  assert.ok(mcpReadTools.filter((tool) => !["bizyeet_payments_received_summary", "bizyeet_bookings_upcoming"].includes(tool.name)).every((tool) => "fields" in tool.inputSchema.properties));
